🎨 PeteArtist A clean, responsive artist portfolio website that introduces Pete, showcases artwork, and provides an easy way for visitors to connect. Designed with simplicity and creativity in mind, the website highlights artwork through a modern, visually appealing layout.

---

🌐 Live Demo 

https://leidymarielreyes23-debug.github.io/PeteArtist/ Repository https://github.com/leidymarielreyes23-debug/PeteArtist Web validator https://validator.w3.org/nu/#textarea
...
About section introducing the artist
Portfolio gallery displaying artwork
...
PeteArtist/ │ ├── index.html ├── style.css ├── images/ └── README.md
...
I first focused on creating the basic HTML structure, then added CSS styling and adjusted the layout for different screen sizes.
...
Structuring a webpage with semantic HTML Styling layouts using CSS Creating a responsive design Publishing a website with GitHub Pages Using Git and GitHub to manage project versions The use of an HTML validator to validate web page:W3C Markup Validation Service.

---

🎯 Purpose

This project was created to demonstrate front-end web development skills while building a professional portfolio website for an artist. It focuses on responsive design, semantic HTML, clean CSS styling, and user-friendly navigation.
...
Include more artwork in the gallery
Add a contact form with validation
Improve accessibility and performance (ARIA labels and keyboard navigation)
...
GitHub: https://github.com/leidymarielreyes23-debug
